...
public class MyStepdefs extends Browsers {
    ...
    public void clickOnContactsPageToVerifyTheTitle() throws Throwable {
        Contacts contacts = new Contacts();
        contacts.clickContacts();
    }

    @And("^click ok Grafik page to verify text$")
    public void clickOkGrafikPageToVerifyText() throws Throwable {
...
//            System.out.println(((Map) map).get("avatar"));
    ...
    public void iSubmitPostRequest() throws Throwable {
        ...
        response = RestAssured.given().baseUri(this.url + this.endpoint).contentType("application/json").header(header).when().post(body);
    }
